    ...
    <div className="mt-20 pb-5">
      ...
      <div className="flex px-16 justify-between items-center">
        <div className="relative">
          ...
          <div className="w-36 absolute top-[15%] right-0 flex flex-col gap-1 items-center border border-bright-sun-400 
          rounded-xl py-3 px-1 backdrop-blur-md">
            <Avatar className="!h-16 !w-16" src="/avatar1.png" alt="it's me" />
            <div className="text-mine-shaft-200 text-sm font-semibold text-center">Complete your profile</div>
