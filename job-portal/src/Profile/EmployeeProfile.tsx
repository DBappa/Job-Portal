    ...
    <div className="w-2/3">
      ...
      <div className="px-3">
         ...
         <div className=" flex flex-wrap gap-2">
            {props.skills && props.skills.map((skill:any,index:any) => (<div key={index} className="bg-bright-sun-300 text-sm font-medium bg-opacity-15 rounded-3xl text-bright-sun-400 px-3 py-1">{skill}</div>))}
         </div>
      </div>
      <Divider mx="xs" my="xl"/>
      <div className="px-3">
         ...
         <div className="flex flex-col gap-3">
            {props.experience && props.experience.map((exp:any,index:any) => (<EmployeeExpCard key={index} {...exp}/>))}
         </div>
      ...
      <div className="px-3">
         ...
         <div className="flex flex-col gap-3">
            {props.certifications && props.certifications.map((cer:any,index:any) => (<EmployeeCertificateCard key={index} {...cer}/>))}
         </div>
